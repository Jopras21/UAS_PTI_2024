        ...
        <div className="bodyHistory">
          ...
          <div>
            ...
            <div className="DescHis">
              <p>
                Sumatera Utara kaya akan keberagaman budaya terutama dalam aspek budaya dan adat istiadat, salah satunya adalah pakaian adat.
                Berikut merupakan beberapa pakaian adat yang ada di Sumatera Utara yang berasal dari berbagai suku yang berbeda
              </p>
            </div>
            <br />
            <div className="cardContainer">
